  ...
  return (
    <div className={`mx-auto max-w-3xl px-4 text-center lg:px-8 ${className}`}>
      <p className="text-base leading-relaxed text-foreground/80">
        A Astral Gás é referência na venda e instalação de aquecedores a gás Rinnai, Komeco e Lorenzetti em Curitiba e região metropolitana. Trabalhamos também com Rheem, Orbis e Bosch entre outras marcas, sempre com assistência técnica autorizada para garantir qualidade do início ao fim.
      </p>
