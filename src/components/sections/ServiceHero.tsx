      ...
      <section className="relative overflow-hidden bg-navy-deep pt-28 pb-16 text-white sm:pt-36 sm:pb-24 lg:pt-40 lg:pb-28">
        {image && (
          <>
            ...
            />
            <div className="absolute inset-0 bg-navy-deep/80 sm:bg-navy-deep/65 md:bg-navy-deep/45 lg:bg-navy-deep/35" />
            <div className="absolute inset-0 bg-gradient-to-r from-navy-deep/95 via-navy-deep/90 to-navy-deep/40" />
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">{ctaButton}<GoogleReviewBadge variant="dark" size="md" /></div>
        </m.div>
      </section>
    );
  }
