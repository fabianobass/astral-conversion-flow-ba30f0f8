        ...
        <div className="mt-6 flex justify-center gap-2">
          {scrollSnaps.map((_, i) => (
            <button
              ...
              className={`h-2 rounded-full transition-all outline-none focus-ring-nav focus-visible:ring-offset-2 ${
