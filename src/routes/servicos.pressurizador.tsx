    ...
    <>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
            <div>
              ...
              <div className="mt-8">
                ...
                >
                  <WhatsAppIcon className="h-4 w-4 sm:h-[18px] sm:w-[18px] md:h-5 md:w-5" /> Pressurizador de água — orçamento no WhatsApp
                </a>
              </div>
            </div>
      ...
      <section className="relative overflow-hidden bg-navy-deep py-20 text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-4 lg:px-8">
          ...
          >
            <WhatsAppIcon className="h-4 w-4 sm:h-[18px] sm:w-[18px] md:h-5 md:w-5" /> Pressurizador de água — orçamento agora
          </a>
        </div>
      </section>
